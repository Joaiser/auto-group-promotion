...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if(localStorage.getItem('auto_group_promotion_modal') !== null) {
        return;
    }
    
    // Comprobamos si el modal ya fue mostrado (utilizando localStorage)
    if (typeof autoGroupPromotionModal !== 'undefined' && autoGroupPromotionModal) {
        if (!localStorage.getItem('auto_group_promotion_modal')) {
            // Creamos el modal
            ...
            closeModalButton.addEventListener('click', function () {
                ...
                // Marcamos que el modal ha sido mostrado usando localStorage
                localStorage.setItem('auto_group_promotion_modal', '1');
            });
        }
    }
});
